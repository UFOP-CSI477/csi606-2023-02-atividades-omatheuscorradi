...
const cidade_schema_1 = require("./interfaces/cidade.schema");
let CidadesModule = class CidadesModule {
};
CidadesModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Cidade', schema: cidade_schema_1.CidadeSchema }])],
        controllers: [cidades_controller_1.CidadesController],
        providers: [cidades_service_1.CidadeService]
    })
], CidadesModule);
