    ...
    <div>
      ...
      <div>
        ...
        <div>
          ...
          <select name="cidadeId" id="cidadeId" value={cidadeId} onChange={(e) => setCidadeId(parseInt(e.target.value))}>
            {cidades.map((cidade) => (
        ...
        <div>
          ...
          <select name="tipoId" id="tipoId" value={tipoId} onChange={(e) => setTipoId(parseInt(e.target.value))}>
